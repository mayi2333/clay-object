...
namespace ClayObject
{
    ...
    public sealed class Clay : DynamicObject, IEnumerable
    {
        ...
        /// <returns></returns>
        public object Solidify(JsonSerializerSettings settings = null)
        {
            return Solidify<object>(settings);
        }
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <returns></returns>
        public T Solidify<T>(JsonSerializerSettings settings = null)
        {
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <returns></returns>
        public IDictionary<string, object> ToDictionary(JsonSerializerSettings settings = null)
        {
            // 数组类型不支持转换成字典
            ...
            return Solidify<Dictionary<string, object>>(settings);
        }
